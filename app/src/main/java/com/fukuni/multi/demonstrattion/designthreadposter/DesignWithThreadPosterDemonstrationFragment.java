package com.fukuni.multi.demonstrattion.designthreadposter;
...
import static com.fukuni.multi.demonstrattion.designthreadposter.ProducerConsumerBenchmarkUseCase.*;

public class DesignWithThreadPosterDemonstrationFragment extends BaseFragment implements Listener{
    ...
    @Override
    public void onBenchmarkCompleted(Result result) {
        mProgress.setVisibility(View.INVISIBLE);
        mBtnStart.setEnabled(true);
        mTxtReceivedMessagesCount.setText("Received message count: " + result.getNumOfReceivedMessages());
