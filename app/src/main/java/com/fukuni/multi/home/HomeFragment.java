    ...
    public void onScreenClicked(ScreenReachableFromHome screenReachableFromHome) {
        switch (screenReachableFromHome) {
            ...
            case DESIGN_RXJAVA:
                ...
                break;
            case EXERCISE_9:
                screenNavigator.toExercise9();
                break;
            case DESIGN_COROUTINES:
                screenNavigator.toDesignWithCoroutines();
                break;
            case EXERCISE_10:
                screenNavigator.toExercise10();
                break;
            case EXERCISE_11:
                screenNavigator.toExercise11();
                break;
            case EXERCISE_12:
                screenNavigator.toExercise12();
                break;
        }
    }
